...
import DialogueTitlePackage from '../DialogueTitle/DialogueTitle'
import DialogueTextPackage from '../DialogueText/DialogueText'
...
export default {
  ...
  configure: config => {
    ...
    // scenes
    config.import(container('dialogue', 'Dialogue', [DialogueTitlePackage, DialogueTextPackage]))
